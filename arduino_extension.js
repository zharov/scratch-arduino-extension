...
(function(ext) {
  ...
  var blocks = {
    ...
    ru: [
      ...
      ['-'],
      [' ', 'установить %m.leds в %m.outputs', 'digitalLED', 'светодиод A', 'вкл'],
      ...
      ['-'],
      [' ', 'установить выход %n в %m.outputs', 'digitalWrite', 1, 'вкл'],
      [' ', 'установить ан. выход %n в %n%', 'analogWrite', 3, 100],
      ['-'],
      ['h', 'когда вход %n %m.outputs', 'whenDigitalRead', 1, 'вкл'],
